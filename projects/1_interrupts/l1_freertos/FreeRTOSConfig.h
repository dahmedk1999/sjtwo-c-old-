...
#define RTOS_MS_TO_TICKS(milliseconds)                                                                                 \
  (milliseconds == UINT32_MAX) ? (portMAX_DELAY) : (((uint64_t)configTICK_RATE_HZ * milliseconds) / 1000)
 ...
 */
#define RTOS_HIGHEST_INTERRUPT_PRIORITY                                                                                \
  (0x03) /* Your interrupts must be equal or lower priority (higher number) than this */

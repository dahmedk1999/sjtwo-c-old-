...
#endif /* defined(TRC_CFG_ENABLE_STACK_MONITOR) && (TRC_CFG_ENABLE_STACK_MONITOR == 1) && (TRC_CFG_SCHEDULING_ONLY ==  \
          0) */
...
#if (((TRC_CFG_RECORDER_MODE == TRC_RECORDER_MODE_SNAPSHOT) && (TRC_CFG_INCLUDE_ISR_TRACING == 1)) ||                  \
...
#endif /* (((TRC_CFG_RECORDER_MODE == TRC_RECORDER_MODE_SNAPSHOT) && (TRC_CFG_INCLUDE_ISR_TRACING == 1)) ||            \
          (TRC_CFG_RECORDER_MODE == TRC_RECORDER_MODE_STREAMING)) */
...
#define TRACE_ENTER_CRITICAL_SECTION()                                                                                 \
  { __irq_mask_status = cortex_a9_enter_critical(); }

#define TRACE_EXIT_CRITICAL_SECTION()                                                                                  \
  { cortex_a9_exit_critical(__irq_mask_status); }

#endif

#if ((TRC_CFG_HARDWARE_PORT == TRC_HARDWARE_PORT_Renesas_RX600) ||                                                     \
     (TRC_CFG_HARDWARE_PORT == TRC_HARDWARE_PORT_MICROCHIP_PIC24_PIC32) ||                                             \
     (TRC_CFG_HARDWARE_PORT == TRC_HARDWARE_PORT_Altera_NiosII))
...
#define EVENTGROUP_SEND_FROM_ISR_TRCSUCCESS (EVENTGROUP_RECEIVE_TRCSUCCESS + 8UL) /*0x30*/

/* Receive/Take operations, from ISR */
#define EVENTGROUP_RECEIVE_FROM_ISR_TRCSUCCESS (EVENTGROUP_SEND_FROM_ISR_TRCSUCCESS + 8UL) /*0x38*/

/* "Failed" event type versions of above (timeout, failed allocation, etc) */
#define EVENTGROUP_KSE_TRCFAILED (EVENTGROUP_RECEIVE_FROM_ISR_TRCSUCCESS + 8UL) /*0x40*/
...
#define EVENTGROUP_RECEIVE_FROM_ISR_TRCFAILED (EVENTGROUP_SEND_FROM_ISR_TRCFAILED + 8UL) /*0x60*/

/* Events when blocking on receive/take */
#define EVENTGROUP_RECEIVE_TRCBLOCK (EVENTGROUP_RECEIVE_FROM_ISR_TRCFAILED + 8UL) /*0x68*/
...
/* The following are using previously "lost" event codes. These macros aren't even directly referenced, instead we do
 * (equivalent STREAMBUFFER code) + 1. */
...
/* TRACE_GET_TRACE_CLASS_FROM_STREAMBUFFER_CLASS can only be accessed with a parameter indicating if it is a
 * MessageBuffer */
...
#define TRACE_GET_TRACE_CLASS_FROM_STREAMBUFFER_OBJECT(pxObject)                                                       \
  (prvGetStreamBufferType(pxObject) == 1 ? TRACE_CLASS_MESSAGEBUFFER : TRACE_CLASS_STREAMBUFFER)
...
#define TRACE_SET_TASK_NUMBER(pxTCB)                                                                                   \
  prvTraceSetTaskNumberLow16(pxTCB, prvTraceGetObjectHandle(TRACE_GET_OBJECT_TRACE_CLASS(TASK, pxTCB)));

#define TRACE_GET_QUEUE_NUMBER(queue) ((traceHandle)prvTraceGetQueueNumberLow16(queue))
#define TRACE_SET_QUEUE_NUMBER(queue)                                                                                  \
  prvTraceSetQueueNumberLow16(queue, (uint16_t)prvTraceGetObjectHandle(TRACE_GET_OBJECT_TRACE_CLASS(QUEUE, queue)));

#if (TRC_CFG_FREERTOS_VERSION >= TRC_FREERTOS_VERSION_10_0_0)
#define TRACE_GET_TIMER_NUMBER(tmr) ((traceHandle)prvTraceGetTimerNumberLow16(tmr))
#define TRACE_SET_TIMER_NUMBER(tmr)                                                                                    \
  prvTraceSetTimerNumberLow16(tmr, (uint16_t)prvTraceGetObjectHandle(TRACE_GET_OBJECT_TRACE_CLASS(TIMER, tmr)));
#else /* (TRC_CFG_FREERTOS_VERSION >= TRC_FREERTOS_VERSION_10_0_0) */
#define TRACE_GET_TIMER_NUMBER(tmr) ((traceHandle)((Timer_t *)tmr)->uxTimerNumber)
#define TRACE_SET_TIMER_NUMBER(tmr)                                                                                    \
  ((Timer_t *)tmr)->uxTimerNumber = prvTraceGetObjectHandle(TRACE_GET_OBJECT_TRACE_CLASS(TIMER, tmr));
#endif /* (TRC_CFG_FREERTOS_VERSION >= TRC_FREERTOS_VERSION_10_0_0) */
...
#define TRACE_SET_EVENTGROUP_NUMBER(eg)                                                                                \
  prvTraceSetEventGroupNumberLow16(eg, (uint16_t)prvTraceGetObjectHandle(TRACE_GET_OBJECT_TRACE_CLASS(EVENTGROUP, eg)));
#else /* (TRC_CFG_FREERTOS_VERSION >= TRC_FREERTOS_VERSION_10_0_0) */
#define TRACE_GET_EVENTGROUP_NUMBER(eg) ((traceHandle)uxEventGroupGetNumber(eg))
#define TRACE_SET_EVENTGROUP_NUMBER(eg)                                                                                \
  ((EventGroup_t *)eg)->uxEventGroupNumber = prvTraceGetObjectHandle(TRACE_GET_OBJECT_TRACE_CLASS(EVENTGROUP, eg));
#endif /* (TRC_CFG_FREERTOS_VERSION >= TRC_FREERTOS_VERSION_10_0_0) */
...
#define TRACE_SET_STREAMBUFFER_NUMBER(sb)                                                                              \
  prvTraceSetStreamBufferNumberLow16(                                                                                  \
      sb, (uint16_t)prvTraceGetObjectHandle(TRACE_GET_OBJECT_TRACE_CLASS(STREAMBUFFER, sb)));
...
#define TRACE_GET_TASK_CLASS_EVENT_CODE(SERVICE, RESULT, kernelClass)                                                  \
  (uint8_t)(EVENTGROUP_##SERVICE##_##RESULT + TRACE_GET_CLASS_TRACE_CLASS(TASK, kernelClass))
#define TRACE_GET_QUEUE_CLASS_EVENT_CODE(SERVICE, RESULT, kernelClass)                                                 \
  (uint8_t)(EVENTGROUP_##SERVICE##_##RESULT + TRACE_GET_CLASS_TRACE_CLASS(QUEUE, kernelClass))
...
#define TRACE_GET_STREAMBUFFER_CLASS_EVENT_CODE(SERVICE, RESULT, isMessageBuffer)                                      \
...
#define TRACE_GET_QUEUE_OBJECT_EVENT_CODE(SERVICE, RESULT, pxObject)                                                   \
  (uint8_t)(EVENTGROUP_##SERVICE##_##RESULT + TRACE_GET_OBJECT_TRACE_CLASS(QUEUE, pxObject))
...
#define TRACE_GET_STREAMBUFFER_OBJECT_EVENT_CODE(SERVICE, RESULT, pxObject)                                            \
  (uint8_t)(TRACE_STREAMBUFFER_##SERVICE##_##RESULT + prvGetStreamBufferType(pxObject))
...
#define traceTASK_DELETE(pxTaskToDelete)                                                                               \
  {                                                                                                                    \
    ...
    trcKERNEL_HOOKS_TASK_DELETE(TRACE_GET_OBJECT_EVENT_CODE(DELETE_OBJ, TRCSUCCESS, TASK, pxTaskToDelete),             \
                                TRACE_GET_OBJECT_EVENT_CODE(OBJCLOSE_NAME, TRCSUCCESS, TASK, pxTaskToDelete),          \
                                TRACE_GET_OBJECT_EVENT_CODE(OBJCLOSE_PROP, TRCSUCCESS, TASK, pxTaskToDelete),          \
                                pxTaskToDelete);                                                                       \
...
#define traceQUEUE_CREATE(pxNewQueue)                                                                                  \
  trcKERNEL_HOOKS_OBJECT_CREATE(TRACE_GET_OBJECT_EVENT_CODE(CREATE_OBJ, TRCSUCCESS, QUEUE, pxNewQueue), QUEUE,         \
                                pxNewQueue);
...
#define traceQUEUE_DELETE(pxQueue)                                                                                     \
  {                                                                                                                    \
    TRACE_ALLOC_CRITICAL_SECTION();                                                                                    \
    TRACE_ENTER_CRITICAL_SECTION();                                                                                    \
    trcKERNEL_HOOKS_OBJECT_DELETE(TRACE_GET_OBJECT_EVENT_CODE(DELETE_OBJ, TRCSUCCESS, QUEUE, pxQueue),                 \
                                  TRACE_GET_OBJECT_EVENT_CODE(OBJCLOSE_NAME, TRCSUCCESS, QUEUE, pxQueue),              \
                                  TRACE_GET_OBJECT_EVENT_CODE(OBJCLOSE_PROP, TRCSUCCESS, QUEUE, pxQueue), QUEUE,       \
                                  pxQueue);                                                                            \
    TRACE_EXIT_CRITICAL_SECTION();                                                                                     \
  }
...
#define traceCREATE_MUTEX_FAILED()                                                                                     \
  trcKERNEL_HOOKS_KERNEL_SERVICE_WITH_NUMERIC_PARAM_ONLY(                                                              \
      TRACE_GET_CLASS_EVENT_CODE(CREATE_OBJ, TRCFAILED, QUEUE, queueQUEUE_TYPE_MUTEX), 0);
#endif /* (TRC_CFG_FREERTOS_VERSION < TRC_FREERTOS_VERSION_9_0_0) */
...
#define traceQUEUE_SEND(pxQueue)                                                                                       \
  trcKERNEL_HOOKS_KERNEL_SERVICE(xCopyPosition == queueSEND_TO_BACK                                                    \
...
/* Expands name if this header is included... uxQueueType must be a macro that only exists in queue.c or whatever, and
 * it must expand to nothing or to something that's valid in identifiers */
...
#define xQueueGiveFromISR__pcHead(__a, __b)                                                                            \
  MyWrapper(__a, __b, const BaseType_t xCopyPosition);                                                                 \
...
#define traceQUEUE_SEND_FROM_ISR(pxQueue)                                                                              \
  trcKERNEL_HOOKS_KERNEL_SERVICE_FROM_ISR(                                                                             \
      xCopyPosition == queueSEND_TO_BACK ? (TRACE_GET_OBJECT_EVENT_CODE(SEND_FROM_ISR, TRCSUCCESS, QUEUE, pxQueue))    \
...
#define traceQUEUE_SEND_FROM_ISR_FAILED(pxQueue)                                                                       \
  trcKERNEL_HOOKS_KERNEL_SERVICE_FROM_ISR(                                                                             \
      xCopyPosition == queueSEND_TO_BACK ? (TRACE_GET_OBJECT_EVENT_CODE(SEND_FROM_ISR, TRCFAILED, QUEUE, pxQueue))     \
...
#define traceQUEUE_RECEIVE_FROM_ISR(pxQueue)                                                                           \
  trcKERNEL_HOOKS_KERNEL_SERVICE_FROM_ISR(TRACE_GET_OBJECT_EVENT_CODE(RECEIVE_FROM_ISR, TRCSUCCESS, QUEUE, pxQueue),   \
                                          QUEUE, pxQueue);                                                             \
  trcKERNEL_HOOKS_SET_OBJECT_STATE(QUEUE, pxQueue, (uint8_t)(pxQueue->uxMessagesWaiting - 1));
...
#define traceQUEUE_RECEIVE_FROM_ISR_FAILED(pxQueue)                                                                    \
  trcKERNEL_HOOKS_KERNEL_SERVICE_FROM_ISR(TRACE_GET_OBJECT_EVENT_CODE(RECEIVE_FROM_ISR, TRCFAILED, QUEUE, pxQueue),    \
                                          QUEUE, pxQueue);

#undef traceQUEUE_REGISTRY_ADD
#define traceQUEUE_REGISTRY_ADD(object, name)                                                                          \
  prvTraceSetObjectName(TRACE_GET_OBJECT_TRACE_CLASS(QUEUE, object), TRACE_GET_OBJECT_NUMBER(QUEUE, object), name);
...
#define traceTIMER_CREATE(tmr) trcKERNEL_HOOKS_OBJECT_CREATE(TIMER_CREATE, TIMER, tmr);
  ...
  if (xCommandID > tmrCOMMAND_START_DONT_TRACE) {                                                                      \
    if (xCommandID == tmrCOMMAND_CHANGE_PERIOD) {                                                                      \
      ...
      trcKERNEL_HOOKS_OBJECT_DELETE(                                                                                   \
          TIMER_DELETE_OBJ, EVENTGROUP_OBJCLOSE_NAME_TRCSUCCESS + TRACE_GET_OBJECT_TRACE_CLASS(TIMER, tmr),            \
          EVENTGROUP_OBJCLOSE_PROP_TRCSUCCESS + TRACE_GET_OBJECT_TRACE_CLASS(TIMER, tmr), TIMER, tmr);                 \
    } else {                                                                                                           \
      trcKERNEL_HOOKS_KERNEL_SERVICE_WITH_PARAM(                                                                       \
          EVENTGROUP_TIMER + (uint32_t)xCommandID +                                                                    \
              ((xReturn == pdPASS) ? 0 : (TIMER_CREATE_TRCFAILED - TIMER_CREATE)),                                     \
          TIMER, tmr, xOptionalValue);                                                                                 \
    }                                                                                                                  \
  }

#undef traceTIMER_EXPIRED
#define traceTIMER_EXPIRED(tmr) trcKERNEL_HOOKS_KERNEL_SERVICE(TIMER_EXPIRED, TIMER, tmr);
...
#define tracePEND_FUNC_CALL_FROM_ISR(func, arg1, arg2, ret)                                                            \
  if (!uiInEventGroupSetBitsFromISR)                                                                                   \
    prvTraceStoreKernelCall(PEND_FUNC_CALL_FROM_ISR, TRACE_CLASS_TASK,                                                 \
...
#define traceEVENT_GROUP_CREATE(eg) trcKERNEL_HOOKS_OBJECT_CREATE(EVENT_GROUP_CREATE, EVENTGROUP, eg);
...
#define traceEVENT_GROUP_DELETE(eg)                                                                                    \
  {                                                                                                                    \
    ...
    TRACE_ENTER_CRITICAL_SECTION();                                                                                    \
    trcKERNEL_HOOKS_OBJECT_DELETE(                                                                                     \
        EVENT_GROUP_DELETE_OBJ, EVENTGROUP_OBJCLOSE_NAME_TRCSUCCESS + TRACE_GET_OBJECT_TRACE_CLASS(EVENTGROUP, eg),    \
        EVENTGROUP_OBJCLOSE_NAME_TRCSUCCESS + TRACE_GET_OBJECT_TRACE_CLASS(EVENTGROUP, eg), EVENTGROUP, eg);           \
    TRACE_EXIT_CRITICAL_SECTION();                                                                                     \
  }
...
#define traceTASK_NOTIFY_WAIT()                                                                                        \
  if (TRACE_GET_OBJECT_FILTER(TASK, pxCurrentTCB) & CurrentFilterMask) {                                               \
    if (pxCurrentTCB->eNotifyState == eNotified)                                                                       \
      prvTraceStoreKernelCallWithParam(TRACE_TASK_NOTIFY_WAIT, TRACE_CLASS_TASK, TRACE_GET_TASK_NUMBER(pxCurrentTCB),  \
                                       xTicksToWait);                                                                  \
    else                                                                                                               \
      prvTraceStoreKernelCallWithParam(TRACE_TASK_NOTIFY_WAIT_TRCFAILED, TRACE_CLASS_TASK,                             \
...
#define traceTASK_NOTIFY_WAIT_BLOCK()                                                                                  \
  if (TRACE_GET_OBJECT_FILTER(TASK, pxCurrentTCB) & CurrentFilterMask)                                                 \
    prvTraceStoreKernelCallWithParam(TRACE_TASK_NOTIFY_WAIT_TRCBLOCK, TRACE_CLASS_TASK,                                \
                                     TRACE_GET_TASK_NUMBER(pxCurrentTCB), xTicksToWait);                               \
  trcKERNEL_HOOKS_SET_TASK_INSTANCE_FINISHED();
...
#define traceSTREAM_BUFFER_CREATE(pxStreamBuffer, xIsMessageBuffer)                                                    \
  trcKERNEL_HOOKS_OBJECT_CREATE(TRACE_GET_OBJECT_EVENT_CODE(CREATE_OBJ, TRCSUCCESS, STREAMBUFFER, pxStreamBuffer),     \
                                STREAMBUFFER, pxStreamBuffer);

#undef traceSTREAM_BUFFER_CREATE_FAILED
#define traceSTREAM_BUFFER_CREATE_FAILED(xIsMessageBuffer)                                                             \
  trcKERNEL_HOOKS_KERNEL_SERVICE_WITH_NUMERIC_PARAM_ONLY(                                                              \
      TRACE_GET_CLASS_EVENT_CODE(CREATE_OBJ, TRCFAILED, STREAMBUFFER, xIsMessageBuffer), 0);
...
#define traceSTREAM_BUFFER_DELETE(xStreamBuffer)                                                                       \
  trcKERNEL_HOOKS_OBJECT_DELETE(TRACE_GET_OBJECT_EVENT_CODE(DELETE_OBJ, TRCSUCCESS, STREAMBUFFER, xStreamBuffer),      \
                                TRACE_GET_OBJECT_EVENT_CODE(OBJCLOSE_NAME, TRCSUCCESS, STREAMBUFFER, xStreamBuffer),   \
                                TRACE_GET_OBJECT_EVENT_CODE(OBJCLOSE_PROP, TRCSUCCESS, STREAMBUFFER, xStreamBuffer),   \
                                STREAMBUFFER, xStreamBuffer);

#undef traceSTREAM_BUFFER_RESET
#define traceSTREAM_BUFFER_RESET(xStreamBuffer)                                                                        \
  trcKERNEL_HOOKS_KERNEL_SERVICE(prvGetStreamBufferType(xStreamBuffer) > 0 ? TRACE_MESSAGEBUFFER_RESET                 \
...
#define traceSTREAM_BUFFER_SEND(xStreamBuffer, xReturn)                                                                \
  trcKERNEL_HOOKS_KERNEL_SERVICE(TRACE_GET_OBJECT_EVENT_CODE(SEND, TRCSUCCESS, STREAMBUFFER, xStreamBuffer),           \
                                 STREAMBUFFER, xStreamBuffer);                                                         \
...
#define traceBLOCKING_ON_STREAM_BUFFER_SEND(xStreamBuffer)                                                             \
  trcKERNEL_HOOKS_KERNEL_SERVICE(TRACE_GET_OBJECT_EVENT_CODE(SEND, TRCBLOCK, STREAMBUFFER, xStreamBuffer),             \
                                 STREAMBUFFER, xStreamBuffer);

#undef traceSTREAM_BUFFER_SEND_FAILED
#define traceSTREAM_BUFFER_SEND_FAILED(xStreamBuffer)                                                                  \
  trcKERNEL_HOOKS_KERNEL_SERVICE(TRACE_GET_OBJECT_EVENT_CODE(SEND, TRCFAILED, STREAMBUFFER, xStreamBuffer),            \
                                 STREAMBUFFER, xStreamBuffer);

#undef traceSTREAM_BUFFER_RECEIVE
#define traceSTREAM_BUFFER_RECEIVE(xStreamBuffer, xReceivedLength)                                                     \
  trcKERNEL_HOOKS_KERNEL_SERVICE(TRACE_GET_OBJECT_EVENT_CODE(RECEIVE, TRCSUCCESS, STREAMBUFFER, xStreamBuffer),        \
                                 STREAMBUFFER, xStreamBuffer);                                                         \
  trcKERNEL_HOOKS_SET_OBJECT_STATE(STREAMBUFFER, xStreamBuffer, prvBytesInBuffer(xStreamBuffer));

#undef traceBLOCKING_ON_STREAM_BUFFER_RECEIVE
#define traceBLOCKING_ON_STREAM_BUFFER_RECEIVE(xStreamBuffer)                                                          \
  trcKERNEL_HOOKS_KERNEL_SERVICE(TRACE_GET_OBJECT_EVENT_CODE(RECEIVE, TRCBLOCK, STREAMBUFFER, xStreamBuffer),          \
                                 STREAMBUFFER, xStreamBuffer);

#undef traceSTREAM_BUFFER_RECEIVE_FAILED
#define traceSTREAM_BUFFER_RECEIVE_FAILED(xStreamBuffer)                                                               \
  trcKERNEL_HOOKS_KERNEL_SERVICE(TRACE_GET_OBJECT_EVENT_CODE(RECEIVE, TRCFAILED, STREAMBUFFER, xStreamBuffer),         \
                                 STREAMBUFFER, xStreamBuffer);
...
#define traceSTREAM_BUFFER_SEND_FROM_ISR(xStreamBuffer, xReturn)                                                       \
  if (xReturn > (size_t)0) {                                                                                           \
    trcKERNEL_HOOKS_KERNEL_SERVICE_FROM_ISR(                                                                           \
        TRACE_GET_OBJECT_EVENT_CODE(SEND_FROM_ISR, TRCSUCCESS, STREAMBUFFER, xStreamBuffer), STREAMBUFFER,             \
        xStreamBuffer);                                                                                                \
    trcKERNEL_HOOKS_SET_OBJECT_STATE(STREAMBUFFER, xStreamBuffer, prvBytesInBuffer(xStreamBuffer));                    \
  } else {                                                                                                             \
    trcKERNEL_HOOKS_KERNEL_SERVICE_FROM_ISR(                                                                           \
        TRACE_GET_OBJECT_EVENT_CODE(SEND_FROM_ISR, TRCFAILED, STREAMBUFFER, xStreamBuffer), STREAMBUFFER,              \
        xStreamBuffer);                                                                                                \
  }
...
#define traceSTREAM_BUFFER_RECEIVE_FROM_ISR(xStreamBuffer, xReceivedLength)                                            \
  if (xReceivedLength > (size_t)0) {                                                                                   \
    trcKERNEL_HOOKS_KERNEL_SERVICE_FROM_ISR(                                                                           \
        TRACE_GET_OBJECT_EVENT_CODE(RECEIVE_FROM_ISR, TRCSUCCESS, STREAMBUFFER, xStreamBuffer), STREAMBUFFER,          \
        xStreamBuffer);                                                                                                \
    trcKERNEL_HOOKS_SET_OBJECT_STATE(STREAMBUFFER, xStreamBuffer, prvBytesInBuffer(xStreamBuffer));                    \
  } else {                                                                                                             \
    trcKERNEL_HOOKS_KERNEL_SERVICE_FROM_ISR(                                                                           \
        TRACE_GET_OBJECT_EVENT_CODE(RECEIVE_FROM_ISR, TRCFAILED, STREAMBUFFER, xStreamBuffer), STREAMBUFFER,           \
        xStreamBuffer);                                                                                                \
  }
...
/* Called on vTaskDelete */
#undef traceTASK_DELETE // We don't allow for filtering out "delete" events. They are important and not very frequent.
                        // Moreover, we can't exclude create events, so this should be symmetrical.
#define traceTASK_DELETE(pxTaskToDelete)                                                                               \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    if (TRACE_GET_OBJECT_FILTER(TASK, pxTaskToDelete) & CurrentFilterMask)                                             \
      prvTraceStoreEvent2(PSF_EVENT_TASK_DELETE, (uint32_t)pxTaskToDelete,                                             \
...
#undef traceQUEUE_DELETE // We don't allow for filtering out "delete" events. They are important and not very frequent.
                         // Moreover, we can't exclude create events, so this should be symmetrical.
#define traceQUEUE_DELETE(pxQueue)                                                                                     \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask) {                                   \
    if (TRACE_GET_OBJECT_FILTER(QUEUE, pxQueue) & CurrentFilterMask) {                                                 \
      ...
      case queueQUEUE_TYPE_BASE:                                                                                       \
        prvTraceStoreEvent2(PSF_EVENT_QUEUE_DELETE, (uint32_t)pxQueue,                                                 \
                            (pxQueue != NULL) ? (pxQueue->uxMessagesWaiting) : 0);                                     \
        break;                                                                                                         \
      case queueQUEUE_TYPE_MUTEX:                                                                                      \
      case queueQUEUE_TYPE_RECURSIVE_MUTEX:                                                                            \
        prvTraceStoreEvent2(PSF_EVENT_MUTEX_DELETE, (uint32_t)pxQueue,                                                 \
                            (pxQueue != NULL) ? (pxQueue->uxMessagesWaiting) : 0);                                     \
        break;                                                                                                         \
      case queueQUEUE_TYPE_COUNTING_SEMAPHORE:                                                                         \
      case queueQUEUE_TYPE_BINARY_SEMAPHORE:                                                                           \
        prvTraceStoreEvent2(PSF_EVENT_SEMAPHORE_DELETE, (uint32_t)pxQueue,                                             \
                            (pxQueue != NULL) ? (pxQueue->uxMessagesWaiting) : 0);                                     \
        break;                                                                                                         \
      }                                                                                                                \
    }                                                                                                                  \
...
#define traceQUEUE_SEND(pxQueue)                                                                                       \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    if (TRACE_GET_OBJECT_FILTER(QUEUE, pxQueue) & CurrentFilterMask)                                                   \
      switch (pxQueue->ucQueueType) {                                                                                  \
      case queueQUEUE_TYPE_BASE:                                                                                       \
        prvTraceStoreEvent2(xCopyPosition == queueSEND_TO_BACK ? PSF_EVENT_QUEUE_SEND : PSF_EVENT_QUEUE_SEND_FRONT,    \
...
#define traceQUEUE_SEND_FAILED(pxQueue)                                                                                \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    if (TRACE_GET_OBJECT_FILTER(QUEUE, pxQueue) & CurrentFilterMask)                                                   \
      switch (pxQueue->ucQueueType) {                                                                                  \
      case queueQUEUE_TYPE_BASE:                                                                                       \
        prvTraceStoreEvent2(xCopyPosition == queueSEND_TO_BACK ? PSF_EVENT_QUEUE_SEND_FAILED                           \
...
#define traceBLOCKING_ON_QUEUE_SEND(pxQueue)                                                                           \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    if (TRACE_GET_OBJECT_FILTER(QUEUE, pxQueue) & CurrentFilterMask)                                                   \
      switch (pxQueue->ucQueueType) {                                                                                  \
      case queueQUEUE_TYPE_BASE:                                                                                       \
        prvTraceStoreEvent2(xCopyPosition == queueSEND_TO_BACK ? PSF_EVENT_QUEUE_SEND_BLOCK                            \
...
#define traceQUEUE_SEND_FROM_ISR(pxQueue)                                                                              \
  if (TRACE_GET_OBJECT_FILTER(QUEUE, pxQueue) & CurrentFilterMask)                                                     \
    switch (pxQueue->ucQueueType) {                                                                                    \
    case queueQUEUE_TYPE_BASE:                                                                                         \
      prvTraceStoreEvent2(xCopyPosition == queueSEND_TO_BACK ? PSF_EVENT_QUEUE_SEND_FROMISR                            \
...
#define traceQUEUE_SEND_FROM_ISR_FAILED(pxQueue)                                                                       \
  if (TRACE_GET_OBJECT_FILTER(QUEUE, pxQueue) & CurrentFilterMask)                                                     \
    switch (pxQueue->ucQueueType) {                                                                                    \
    case queueQUEUE_TYPE_BASE:                                                                                         \
      prvTraceStoreEvent2(xCopyPosition == queueSEND_TO_BACK ? PSF_EVENT_QUEUE_SEND_FROMISR_FAILED                     \
    ...
    if (TRACE_GET_OBJECT_FILTER(QUEUE, pxQueue) & CurrentFilterMask)                                                   \
      ...
      case queueQUEUE_TYPE_BASE:                                                                                       \
        if (isQueueReceiveHookActuallyPeek)                                                                            \
          ...
          prvTraceStoreEvent3(PSF_EVENT_QUEUE_RECEIVE, (uint32_t)pxQueue, xTicksToWait,                                \
                              pxQueue->uxMessagesWaiting - 1);                                                         \
        break;                                                                                                         \
      case queueQUEUE_TYPE_BINARY_SEMAPHORE:                                                                           \
      case queueQUEUE_TYPE_COUNTING_SEMAPHORE:                                                                         \
        if (isQueueReceiveHookActuallyPeek)                                                                            \
          prvTraceStoreEvent3(PSF_EVENT_SEMAPHORE_PEEK, (uint32_t)pxQueue, xTicksToWait,                               \
                              pxQueue->uxMessagesWaiting - 1);                                                         \
        else                                                                                                           \
          prvTraceStoreEvent3(PSF_EVENT_SEMAPHORE_TAKE, (uint32_t)pxQueue, xTicksToWait,                               \
                              pxQueue->uxMessagesWaiting - 1);                                                         \
        break;                                                                                                         \
      case queueQUEUE_TYPE_MUTEX:                                                                                      \
      case queueQUEUE_TYPE_RECURSIVE_MUTEX:                                                                            \
...
#define traceQUEUE_RECEIVE_FAILED(pxQueue)                                                                             \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    if (TRACE_GET_OBJECT_FILTER(QUEUE, pxQueue) & CurrentFilterMask)                                                   \
      switch (pxQueue->ucQueueType) {                                                                                  \
      case queueQUEUE_TYPE_BASE:                                                                                       \
        prvTraceStoreEvent3(isQueueReceiveHookActuallyPeek ? PSF_EVENT_QUEUE_PEEK_FAILED                               \
                                                           : PSF_EVENT_QUEUE_RECEIVE_FAILED,                           \
                            (uint32_t)pxQueue, xTicksToWait, pxQueue->uxMessagesWaiting);                              \
        break;                                                                                                         \
      case queueQUEUE_TYPE_BINARY_SEMAPHORE:                                                                           \
      case queueQUEUE_TYPE_COUNTING_SEMAPHORE:                                                                         \
        prvTraceStoreEvent3(isQueueReceiveHookActuallyPeek ? PSF_EVENT_SEMAPHORE_PEEK_FAILED                           \
                                                           : PSF_EVENT_SEMAPHORE_TAKE_FAILED,                          \
                            (uint32_t)pxQueue, xTicksToWait, pxQueue->uxMessagesWaiting);                              \
        break;                                                                                                         \
      case queueQUEUE_TYPE_MUTEX:                                                                                      \
      case queueQUEUE_TYPE_RECURSIVE_MUTEX:                                                                            \
        prvTraceStoreEvent2(isQueueReceiveHookActuallyPeek ? PSF_EVENT_MUTEX_PEEK_FAILED                               \
...
#define traceBLOCKING_ON_QUEUE_RECEIVE(pxQueue)                                                                        \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    if (TRACE_GET_OBJECT_FILTER(QUEUE, pxQueue) & CurrentFilterMask)                                                   \
      switch (pxQueue->ucQueueType) {                                                                                  \
      case queueQUEUE_TYPE_BASE:                                                                                       \
        prvTraceStoreEvent3(isQueueReceiveHookActuallyPeek ? PSF_EVENT_QUEUE_PEEK_BLOCK                                \
                                                           : PSF_EVENT_QUEUE_RECEIVE_BLOCK,                            \
                            (uint32_t)pxQueue, xTicksToWait, pxQueue->uxMessagesWaiting);                              \
        break;                                                                                                         \
      case queueQUEUE_TYPE_BINARY_SEMAPHORE:                                                                           \
      case queueQUEUE_TYPE_COUNTING_SEMAPHORE:                                                                         \
        prvTraceStoreEvent3(isQueueReceiveHookActuallyPeek ? PSF_EVENT_SEMAPHORE_PEEK_BLOCK                            \
                                                           : PSF_EVENT_SEMAPHORE_TAKE_BLOCK,                           \
                            (uint32_t)pxQueue, xTicksToWait, pxQueue->uxMessagesWaiting);                              \
        break;                                                                                                         \
      case queueQUEUE_TYPE_MUTEX:                                                                                      \
      case queueQUEUE_TYPE_RECURSIVE_MUTEX:                                                                            \
        prvTraceStoreEvent2(isQueueReceiveHookActuallyPeek ? PSF_EVENT_MUTEX_PEEK_BLOCK : PSF_EVENT_MUTEX_TAKE_BLOCK,  \
                            (uint32_t)pxQueue, xTicksToWait);                                                          \
        break;                                                                                                         \
      }
...
#define traceQUEUE_PEEK_FAILED(pxQueue)                                                                                \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    if (TRACE_GET_OBJECT_FILTER(QUEUE, pxQueue) & CurrentFilterMask)                                                   \
      ...
      case queueQUEUE_TYPE_BINARY_SEMAPHORE:                                                                           \
      case queueQUEUE_TYPE_COUNTING_SEMAPHORE:                                                                         \
        prvTraceStoreEvent3(PSF_EVENT_SEMAPHORE_PEEK_FAILED, (uint32_t)pxQueue, xTicksToWait,                          \
...
#define traceBLOCKING_ON_QUEUE_PEEK(pxQueue)                                                                           \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    if (TRACE_GET_OBJECT_FILTER(QUEUE, pxQueue) & CurrentFilterMask)                                                   \
      ...
      case queueQUEUE_TYPE_BINARY_SEMAPHORE:                                                                           \
      case queueQUEUE_TYPE_COUNTING_SEMAPHORE:                                                                         \
        prvTraceStoreEvent3(PSF_EVENT_SEMAPHORE_PEEK_BLOCK, (uint32_t)pxQueue, xTicksToWait,                           \
                            pxQueue->uxMessagesWaiting);                                                               \
        break;                                                                                                         \
      case queueQUEUE_TYPE_MUTEX:                                                                                      \
      case queueQUEUE_TYPE_RECURSIVE_MUTEX:                                                                            \
...
#define traceFREE(pvAddress, uiSize)                                                                                   \
  trcHeapCounter -= uiSize;                                                                                            \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    prvTraceStoreEvent2(PSF_EVENT_FREE, (uint32_t)pvAddress,                                                           \
                        (uint32_t)(0 - uiSize)); /* "0 -" instead of just "-" to get rid of a warning... */
...
#define traceTIMER_COMMAND_SEND_8_0_CASES(tmr)                                                                         \
  case tmrCOMMAND_RESET:                                                                                               \
    prvTraceStoreEvent2((xReturn == pdPASS) ? PSF_EVENT_TIMER_RESET : PSF_EVENT_TIMER_RESET_FAILED, (uint32_t)tmr,     \
                        xOptionalValue);                                                                               \
    break;                                                                                                             \
  case tmrCOMMAND_START_FROM_ISR:                                                                                      \
    prvTraceStoreEvent2((xReturn == pdPASS) ? PSF_EVENT_TIMER_START_FROMISR : PSF_EVENT_TIMER_START_FROMISR_FAILED,    \
                        (uint32_t)tmr, xOptionalValue);                                                                \
    break;                                                                                                             \
  case tmrCOMMAND_RESET_FROM_ISR:                                                                                      \
    prvTraceStoreEvent2((xReturn == pdPASS) ? PSF_EVENT_TIMER_RESET_FROMISR : PSF_EVENT_TIMER_RESET_FROMISR_FAILED,    \
                        (uint32_t)tmr, xOptionalValue);                                                                \
    break;                                                                                                             \
  case tmrCOMMAND_STOP_FROM_ISR:                                                                                       \
    prvTraceStoreEvent2((xReturn == pdPASS) ? PSF_EVENT_TIMER_STOP_FROMISR : PSF_EVENT_TIMER_STOP_FROMISR_FAILED,      \
                        (uint32_t)tmr, xOptionalValue);                                                                \
    break;                                                                                                             \
  case tmrCOMMAND_CHANGE_PERIOD_FROM_ISR:                                                                              \
    prvTraceStoreEvent2((xReturn == pdPASS) ? PSF_EVENT_TIMER_CHANGEPERIOD_FROMISR                                     \
  ...
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    if (TRACE_GET_OBJECT_FILTER(TIMER, tmr) & CurrentFilterMask)                                                       \
      ...
      case tmrCOMMAND_START:                                                                                           \
        prvTraceStoreEvent1((xReturn == pdPASS) ? PSF_EVENT_TIMER_START : PSF_EVENT_TIMER_START_FAILED,                \
                            (uint32_t)tmr);                                                                            \
        break;                                                                                                         \
      ...
      case tmrCOMMAND_CHANGE_PERIOD:                                                                                   \
        prvTraceStoreEvent2((xReturn == pdPASS) ? PSF_EVENT_TIMER_CHANGEPERIOD : PSF_EVENT_TIMER_CHANGEPERIOD_FAILED,  \
                            (uint32_t)tmr, xOptionalValue);                                                            \
        break;                                                                                                         \
      case tmrCOMMAND_DELETE:                                                                                          \
        prvTraceStoreEvent1((xReturn == pdPASS) ? PSF_EVENT_TIMER_DELETE : PSF_EVENT_TIMER_DELETE_FAILED,              \
                            (uint32_t)tmr);                                                                            \
        break;                                                                                                         \
...
#undef tracePEND_FUNC_CALL
#define tracePEND_FUNC_CALL(func, arg1, arg2, ret)                                                                     \
  prvTraceStoreEvent1((ret == pdPASS) ? PSF_EVENT_TIMER_PENDFUNCCALL : PSF_EVENT_TIMER_PENDFUNCCALL_FAILED,            \
                      (uint32_t)func);

#undef tracePEND_FUNC_CALL_FROM_ISR
#define tracePEND_FUNC_CALL_FROM_ISR(func, arg1, arg2, ret)                                                            \
  prvTraceStoreEvent1((ret == pdPASS) ? PSF_EVENT_TIMER_PENDFUNCCALL_FROMISR                                           \
...
#define traceEVENT_GROUP_SYNC_END(eg, bitsToSet, bitsToWaitFor, wasTimeout)                                            \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    if (TRACE_GET_OBJECT_FILTER(EVENTGROUP, eg) & CurrentFilterMask)                                                   \
      prvTraceStoreEvent2((wasTimeout != pdTRUE) ? PSF_EVENT_EVENTGROUP_SYNC : PSF_EVENT_EVENTGROUP_SYNC_FAILED,       \
...
#define traceEVENT_GROUP_WAIT_BITS_END(eg, bitsToWaitFor, wasTimeout)                                                  \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    if (TRACE_GET_OBJECT_FILTER(EVENTGROUP, eg) & CurrentFilterMask)                                                   \
      prvTraceStoreEvent2((wasTimeout != pdTRUE) ? PSF_EVENT_EVENTGROUP_WAITBITS                                       \
...
#define traceSTREAM_BUFFER_CREATE(pxStreamBuffer, xIsMessageBuffer)                                                    \
  ...
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    if (TRACE_GET_OBJECT_FILTER(STREAMBUFFER, pxStreamBuffer) & CurrentFilterMask)                                     \
      prvTraceStoreEvent2(xIsMessageBuffer == 1 ? PSF_EVENT_MESSAGEBUFFER_CREATE : PSF_EVENT_STREAMBUFFER_CREATE,      \
                          (uint32_t)pxStreamBuffer, xBufferSizeBytes);

#undef traceSTREAM_BUFFER_CREATE_FAILED
#define traceSTREAM_BUFFER_CREATE_FAILED(xIsMessageBuffer)                                                             \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    prvTraceStoreEvent2(xIsMessageBuffer == 1 ? PSF_EVENT_MESSAGEBUFFER_CREATE_FAILED                                  \
...
#define traceSTREAM_BUFFER_DELETE(xStreamBuffer)                                                                       \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    if (TRACE_GET_OBJECT_FILTER(STREAMBUFFER, pxStreamBuffer) & CurrentFilterMask)                                     \
      prvTraceStoreEvent2(prvGetStreamBufferType(xStreamBuffer) > 0 ? PSF_EVENT_MESSAGEBUFFER_DELETE                   \
...
#define traceSTREAM_BUFFER_RESET(xStreamBuffer)                                                                        \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    if (TRACE_GET_OBJECT_FILTER(STREAMBUFFER, xStreamBuffer) & CurrentFilterMask)                                      \
      prvTraceStoreEvent2(prvGetStreamBufferType(xStreamBuffer) > 0 ? PSF_EVENT_MESSAGEBUFFER_RESET                    \
...
#define traceSTREAM_BUFFER_SEND(xStreamBuffer, xReturn)                                                                \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    if (TRACE_GET_OBJECT_FILTER(STREAMBUFFER, xStreamBuffer) & CurrentFilterMask)                                      \
      prvTraceStoreEvent2(prvGetStreamBufferType(xStreamBuffer) > 0 ? PSF_EVENT_MESSAGEBUFFER_SEND                     \
...
#define traceBLOCKING_ON_STREAM_BUFFER_SEND(xStreamBuffer)                                                             \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    if (TRACE_GET_OBJECT_FILTER(STREAMBUFFER, xStreamBuffer) & CurrentFilterMask)                                      \
      prvTraceStoreEvent1(prvGetStreamBufferType(xStreamBuffer) > 0 ? PSF_EVENT_MESSAGEBUFFER_SEND_BLOCK               \
...
#define traceSTREAM_BUFFER_SEND_FAILED(xStreamBuffer)                                                                  \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    if (TRACE_GET_OBJECT_FILTER(STREAMBUFFER, xStreamBuffer) & CurrentFilterMask)                                      \
      prvTraceStoreEvent1(prvGetStreamBufferType(xStreamBuffer) > 0 ? PSF_EVENT_MESSAGEBUFFER_SEND_FAILED              \
...
#define traceSTREAM_BUFFER_RECEIVE(xStreamBuffer, xReceivedLength)                                                     \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    if (TRACE_GET_OBJECT_FILTER(STREAMBUFFER, xStreamBuffer) & CurrentFilterMask)                                      \
      prvTraceStoreEvent2(prvGetStreamBufferType(xStreamBuffer) > 0 ? PSF_EVENT_MESSAGEBUFFER_RECEIVE                  \
...
#define traceSTREAM_BUFFER_RECEIVE_FAILED(xStreamBuffer)                                                               \
  if (TRACE_GET_OBJECT_FILTER(TASK, TRACE_GET_CURRENT_TASK()) & CurrentFilterMask)                                     \
    if (TRACE_GET_OBJECT_FILTER(STREAMBUFFER, xStreamBuffer) & CurrentFilterMask)                                      \
      prvTraceStoreEvent1(prvGetStreamBufferType(xStreamBuffer) > 0 ? PSF_EVENT_MESSAGEBUFFER_RECEIVE_FAILED           \
...
#define traceSTREAM_BUFFER_SEND_FROM_ISR(xStreamBuffer, xReturn)                                                       \
  if (TRACE_GET_OBJECT_FILTER(STREAMBUFFER, xStreamBuffer) & CurrentFilterMask) {                                      \
    if (xReturn > (size_t)0) {                                                                                         \
      prvTraceStoreEvent2(prvGetStreamBufferType(xStreamBuffer) > 0 ? PSF_EVENT_MESSAGEBUFFER_SEND_FROM_ISR            \
                                                                    : PSF_EVENT_STREAMBUFFER_SEND_FROM_ISR,            \
                          (uint32_t)xStreamBuffer, prvBytesInBuffer(xStreamBuffer));                                   \
    } else {                                                                                                           \
      prvTraceStoreEvent1(prvGetStreamBufferType(xStreamBuffer) > 0 ? PSF_EVENT_MESSAGEBUFFER_SEND_FROM_ISR_FAILED     \
...
#define traceSTREAM_BUFFER_RECEIVE_FROM_ISR(xStreamBuffer, xReceivedLength)                                            \
  if (TRACE_GET_OBJECT_FILTER(STREAMBUFFER, xStreamBuffer) & CurrentFilterMask) {                                      \
    if (xReceivedLength > (size_t)0) {                                                                                 \
      prvTraceStoreEvent2(prvGetStreamBufferType(xStreamBuffer) > 0 ? PSF_EVENT_MESSAGEBUFFER_RECEIVE_FROM_ISR         \
                                                                    : PSF_EVENT_STREAMBUFFER_RECEIVE_FROM_ISR,         \
                          (uint32_t)xStreamBuffer, prvBytesInBuffer(xStreamBuffer));                                   \
    } else {                                                                                                           \
      prvTraceStoreEvent1(prvGetStreamBufferType(xStreamBuffer) > 0 ? PSF_EVENT_MESSAGEBUFFER_RECEIVE_FROM_ISR_FAILED  \

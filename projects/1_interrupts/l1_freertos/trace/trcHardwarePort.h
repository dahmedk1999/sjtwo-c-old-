...
#define TRC_CA9_MPCORE_PRIVCTR_PERIOD_REG                                                                              \
  (*(volatile uint32_t *)(TRC_CA9_MPCORE_PERIPHERAL_BASE_ADDRESS + TRC_CA9_MPCORE_PRIVATE_MEMORY_OFFSET + 0x00))
#define TRC_CA9_MPCORE_PRIVCTR_COUNTER_REG                                                                             \
  (*(volatile uint32_t *)(TRC_CA9_MPCORE_PERIPHERAL_BASE_ADDRESS + TRC_CA9_MPCORE_PRIVATE_MEMORY_OFFSET + 0x04))
#define TRC_CA9_MPCORE_PRIVCTR_CONTROL_REG                                                                             \
  (*(volatile uint32_t *)(TRC_CA9_MPCORE_PERIPHERAL_BASE_ADDRESS + TRC_CA9_MPCORE_PRIVATE_MEMORY_OFFSET + 0x08))
...
#define TRC_CA9_MPCORE_PRIVCTR_PRESCALER                                                                               \
  (((TRC_CA9_MPCORE_PRIVCTR_CONTROL_REG & TRC_CA9_MPCORE_PRIVCTR_CONTROL_PRESCALER_MASK) >>                            \
...
#define TRC_HWTC_PERIOD                                                                                                \
  ((configPIT_CLOCK_HZ / configTICK_RATE_HZ) - 1U) // TODO FIXME or maybe not -1? what's the right "period" value?
...
#if !(defined(TRC_HWTC_TYPE) && defined(TRC_HWTC_COUNT) && defined(TRC_HWTC_PERIOD) && defined(TRC_HWTC_FREQ_HZ) &&    \
